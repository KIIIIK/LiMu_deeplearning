...
def resnet_block(input_channels, num_channels, num_residuals, first_block=False):
    ...
    for i in range(num_residuals):
        if i == 0 and not first_block:
            blk.append(Residual(input_channels, num_channels, use_1x1conv=False, strides=2))
        else:
...
net = nn.Sequential(b1, b2, b3, b4, b5, nn.AdaptiveAvgPool1d((1, 2)), nn.Flatten(), nn.Linear(512, 10))
